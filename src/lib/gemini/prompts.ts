...
${variantInfo.nucleotideChange ? `- Nucleotide Change: ${variantInfo.nucleotideChange}` : ""}
${variantInfo.aminoAcidChange ? `- Amino Acid Change: ${variantInfo.aminoAcidChange}` : ""}

**CIViC Database Information:**
...
**Report Context:**
Variant: ${reportContext.variantInfo.gene} ${reportContext.variantInfo.variant || ""}

**Generated Report:**
${reportContext.report}

${reportContext.civicData ? `**CIViC Data:**\n${JSON.stringify(reportContext.civicData, null, 2)}` : ""}
